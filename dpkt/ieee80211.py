...
if __name__ == '__main__':
    ...
    class IEEE80211TestCase(unittest.TestCase):
        ...
        def test_data_ds(self):
            ...
            s = '\x08\x03\x00\x00\x01\x0b\x85\x00\x00\x00\x00\x26\xcb\x18\x73\x50\x01\x0b\x85\x00\x00\x00\x00\x89\x00\x26\xcb\x18\x73\x50\xff\xff\xff\xff'
            ieee = IEEE80211(s)
            self.failUnless(ieee.type == DATA_TYPE)
            ...
            s = '\x88\x41\x50\x01\x00\x26\xcb\x17\x48\xc1\x00\x24\x2c\xe7\xfe\x8a\xff\xff\xff\xff\xff\xff\x80\xa0\x00\x00\x09\x1a\x00\x20\x00\x00\x00\x00\xff\xff\xff\xff'
            ieee = IEEE80211(s)
            self.failUnless(ieee.type == DATA_TYPE)
            self.failUnless(ieee.to_ds == 1)
            self.failUnless(ieee.from_ds == 0)
            ...
            s = '\x08\x02\x02\x01\x00\x02\x44\xac\x27\x70\x00\x1f\x33\x39\x75\x44\x00\x1f\x33\x39\x75\x44\x90\xa4\xff\xff\xff\xff'
            ieee = IEEE80211(s)
            self.failUnless(ieee.type == DATA_TYPE)
            self.failUnless(ieee.to_ds == 0)
            self.failUnless(ieee.from_ds == 1)
